...
const _kAutoConsume = true;

const _kConsumableId = 'consumable_test01';
const _kUpgradeId = 'upgrade';
const _kSilverSubscriptionId = 'subscription_silver';
const _kGoldSubscriptionId = 'subscription_test01';
